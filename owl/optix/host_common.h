...
/*! \file optix/host_common.h Creates a common set of includes,
    #defines, and helpers that _all_ host-files can assume as given */

#pragma once

/* include/define whatever should be common across all host _and_
   device files: */
#include "common.h"
...
// host-side only parts of gdt
#include "gdt/parallel/parallel_for.h"
// and host-side only parts of std
#include <vector>
#include <memory>
#include <mutex>
#include <map>
