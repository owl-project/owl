...
namespace owl {
  ...
  struct Buffer : public RegisteredObject
  {
    ...
    virtual void upload(const void *hostPtr, size_t offset, size_t count) = 0;

    /*! upload data from host, to only given device ID */
    virtual void upload(const int deviceID, const void *hostPtr, size_t offset, size_t count) = 0;
  ...
  struct DeviceBuffer : public Buffer {
    ...
    struct DeviceData : public Buffer::DeviceData {
      ...
      virtual void uploadAsync(const void *hostDataPtr, size_t offset, size_t count) = 0;
    ...
    struct DeviceDataForTextures : public DeviceData {
      ...
      void uploadAsync(const void *hostDataPtr, size_t offset, size_t count) override;
    ...
    void upload(const void *hostPtr, size_t offset, size_t count) override;
    
    /*! upload to only ONE device - only makes sense for device buffers */
    void upload(const int deviceID, const void *hostPtr, size_t offset, size_t count) override;
